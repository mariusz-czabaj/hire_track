...
- [ ] 4.1 npm run test passes (unit + component + integration)
- [ ] 4.2 npm run test:e2e passes
- [ ] 4.3 rls_verification.sql passes
- [ ] 4.4 lint and build pass

#### Manual

- [ ] 4.5 Full manual pass through create → status-change flow
